...
# with configuring your because environment.                        #
#                                                                     #
# https://www.because.ai/docs/configuration/dotenv                  #
#=====================================================================#
...
MONGO_URI=mongodb://host.docker.internal:27018/BecauseAi
...
# CONFIG_PATH="/alternative/path/to/because.yaml"
...
#===================================#
# Known Endpoints - because.yaml  #
#===================================#
# https://www.because.ai/docs/configuration/because_yaml/ai_endpoints
...
# Use the `because.yaml` configuration for `azureOpenAI` instead
# You may also continue to use them if you opt out of using the `because.yaml` configuration
...
# https://www.because.ai/docs/configuration/because_yaml/ai_endpoints/azure#using-assistants-with-azure
...
#                        RAG                       #
#==================================================#
# More info: https://www.because.ai/docs/configuration/rag_api
...
# If you have another service in front of your because doing compression, disable express based compression here
...
#====================================#
# because Code Interpreter API     #
#====================================#

# https://code.because.ai
# because_CODE_API_KEY=your-key
...
# https://because.ai/docs/features/web_search
